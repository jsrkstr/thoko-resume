  ...
  render() {
    return (
      <div className="work-ex mb-3">
        <div className="work-ex-title theme-title-1">{this.props.info.title}</div>
        <div className="layout mb-1">
          <div className="flex work-ex-company theme-title-2">{this.props.info.company}</div>
          <div className="flex work-ex-company-type theme-label text-right">{this.props.info.companyType}</div>
        </div>
        ...
        {this.props.info.items.map((item) => (
          <div className="work-ex-item mb-2 relative" key={item.id}>
            ...
            <div className="work-ex-item-text theme-body-1">{item.text}</div>
          </div>
        ))}
      </div>
    );
